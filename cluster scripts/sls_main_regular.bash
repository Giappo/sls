...
echo "sls:::sls_ML_cluster(s=args[1],simpars=c(args[2],args[3],args[4],args[5]),cond=args[6],t_d=4,fun=eval(parse(text = paste0('sls::loglik_', args[7]))))" >> zzz_ML_regular.R
