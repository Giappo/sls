                           ...
                           tolerance = 1E-2)
{
  ...
  out_sls <- c(MLE_sls, NM, NS, s);
  names(out_sls) <- c(names(MLE_sls), "tips_M", "tips_S", "tree_id")
  ...
  out_DDD <- c(MLE_sls, NM, NS, s);
  names(out_DDD) <- c(names(MLE_DDD), "tips_M", "tips_S", "tree_id")
